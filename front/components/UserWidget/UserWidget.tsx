      ...
      {!user?.login ? (
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 rounded-full bg-white/60 dark:bg-black/40 border border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-800 shadow-sm transition"
          >
            <img
