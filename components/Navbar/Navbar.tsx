  ...
  return (
    <>
      <nav className="bg-white dark:bg-black text-black dark:text-white py-4 shadow-md border-b border-neutral-200 dark:border-neutral-800 z-50 relative">
        <div className="flex items-center justify-between gap-4 px-4 w-full max-w-7xl mx-auto flex-nowrap overflow-x-auto whitespace-nowrap">
          {/* Logo */}
          ...
          {/* SearchBar visible solo en desktop */}
          <div className="hidden md:flex flex-grow mx-4 min-w-[200px] max-w-[400px]">
        ...
        {/* SearchBar visible solo en mobile */}
